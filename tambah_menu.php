...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu'])){
    ...
    $detail_menu =$result_data_edit['detail_menu'];
        ...
        <div class="widget-content" >
          ...
          <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input name="detail_menu" type="text" value="<?php echo $detail_menu; ?>" class="span11" placeholder="detail Menu"/>
              </div>
            </div>
            <div class="control-group">
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "insert into tb_masakan values ('$id_masakan','$nama_masakan','$detail_menu','$harga','$stok','$status_masakan','$gambar')";
              ...
              $query_ubah_masakan = "update tb_masakan set nama_masakan = '$nama_masakan',detail_menu = '$detail_menu', harga = '$harga', stok = '$stok', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";;
            ...
            else if(isset($_REQUEST['batal_menu'])){
