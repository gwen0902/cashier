        ...
        <tr>
          ...
          <td>
            ...
            <?php
                  ...
                  $r_sudah_order = mysqli_fetch_array($sql_sudah_order);
                ?>
          <ul class="quick-actions">
            <li class="bg_lg">
          <a target='_blank' href="cetak_laporan.php?konten=<?php echo $r_sudah_order['id_order'];?>" >
            <i class='icon icon-print'></i> &nbsp; <h4>Cetak</h4>
          </a>
          </li>
          </ul>
          </form>
